...
from malu.api.ws import make_persisting_event_handler, router as ws_router
...
async def lifespan(app: FastAPI):
    ...
    # Initialize DB repositories (before manager: event handler persists trades)
    ...
    manager = BotManager(
        ...
        on_event=make_persisting_event_handler(trade_repo),
